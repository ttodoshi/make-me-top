...
public class CourseRegistrationRequestKeeperService {
    ...
    @Transactional
    public CourseRegistrationRequestKeeper saveKeeperResponseWithStatus(CourseRegistrationRequestKeeper keeperResponse, CourseRegistrationRequestKeeperStatusType keeperResponseStatus) {
        Integer keeperResponseStatusId = findCourseRegistrationRequestKeeperStatusId(
                keeperResponseStatus);
