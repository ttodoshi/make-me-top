...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<Integer, Integer> deleteHomeworksFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<Integer, Integer> deleteHomeworksKafkaListenerContainerFactory() {
