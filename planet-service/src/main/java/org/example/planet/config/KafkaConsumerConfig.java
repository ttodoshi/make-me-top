...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<Long, String> updatePlanetFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<Long, String> updatePlanetKafkaListenerContainerFactory() {
