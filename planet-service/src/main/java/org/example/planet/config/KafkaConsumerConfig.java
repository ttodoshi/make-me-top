...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<Integer, String> updatePlanetFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<Integer, String> updatePlanetKafkaListenerContainerFactory() {
    ...
    @Bean
    public ConsumerFactory<Integer, Integer> deletePlanetsFactory() {
        Map<String, Object> properties = new HashMap<>();
        properties.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapAddress);
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, "planet");
        properties.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, IntegerDeserializer.class);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<Integer, Integer> deletePlanetsKafkaListenerContainerFactory() {
