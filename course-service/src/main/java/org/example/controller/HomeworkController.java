...
public class HomeworkController {
    ...
    @PreAuthorize("@roleService.hasAnyCourseRoleByThemeId(#themeId, T(org.example.model.CourseRoleType).EXPLORER) ||" +
            ...
            "@roleService.hasAnyGeneralRole(T(org.example.model.GeneralRoleType).BIG_BROTHER)") // TODO
    ...
    @PreAuthorize("@roleService.hasAnyCourseRoleByThemeId(#themeId, T(org.example.model.CourseRoleType).KEEPER) ||" +
    ...
    public ResponseEntity<?> addHomework(@PathVariable("themeId") Integer themeId,
                                         @RequestBody CreateHomework homework) {
        return ResponseEntity.ok(homeworkService.addHomework(themeId, homework));
    }

    @PutMapping("homework/{homeworkId}")
    @PreAuthorize("@roleService.hasAnyCourseRoleByHomeworkId(#homeworkId, T(org.example.model.CourseRoleType).KEEPER) ||" +
            "@roleService.hasAnyGeneralRole(T(org.example.model.GeneralRoleType).BIG_BROTHER)")
    ...
    public ResponseEntity<?> updateHomework(@PathVariable("homeworkId") Integer homeworkId,
                                            @RequestBody UpdateHomework homework) {
